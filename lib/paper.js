...
class PrefPaper {
	...
	constructor(bula, refe = 0, p1 = "p1", p2 = "p2", p3 = "p3") {
		...
		this.usedRefe = 0;
		this.p1 = new PrefPaperPlayer(this, p1, this.bula, this.refe);
		this.p2 = new PrefPaperPlayer(this, p2, this.bula, this.refe);
		this.p3 = new PrefPaperPlayer(this, p3, this.bula, this.refe);

		this.p1.setNeighbours(this.p3.getUsername(), this.p2.getUsername());
		this.p2.setNeighbours(this.p1.getUsername(), this.p3.getUsername());
		this.p3.setNeighbours(this.p2.getUsername(), this.p1.getUsername());

		this.p1.calculateScore();
		this.p2.calculateScore();
		this.p3.calculateScore();
	...
	processHand(hand) {
		...
		mainPlayer.calculateScore();
		leftPlayer.calculateScore();
		rightPlayer.calculateScore();
